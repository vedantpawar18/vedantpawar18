<div align="center">
  <img src="https://www.softprodigy.com/wp-content/uploads/2021/06/JS-Development-Gif.gif" alt="MasterHead" width="100%">
</div>
...
- 🌐 Developed scalable web applications using **MERN Stack** and **WebSocket** technology
- ☁️ Implemented cloud infrastructure using **AWS Services** (EC2, S3, Lambda, RDS)
- 📊 Built real-time dashboards with **Socket.io** and **WebSocket**
- 🔄 Managed state using **Redux** & **Context API**
- 🚀 Deployed applications using **Docker**, **PM2**, and **Nginx**
...
![Socket.io-client](https://img.shields.io/badge/Socket.io--client-010101?style=for-the-badge&logo=socket.io&logoColor=white)
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=vedantpawar18&show_icons=true&theme=tokyonight&hide_border=true" alt="GitHub Stats" height="170"/> 
</div>
...
- 📊 Interactive dashboards with real-time data visualization using WebSocket
- 🔧 **Tech Stack**: React, Socket.io, Node.js, MongoDB, AWS
- 📈 Features: Real-time updates, Interactive charts, Data filtering
- 🚀 Deployed on AWS using EC2, Nginx, and PM2

### GeoTIFF Mapping Tool
- 🗺️ Large-scale geospatial data visualization tool
- 🔧 **Tech Stack**: Node.js, Express, AWS S3, Lambda
- 📈 Optimized image processing with AWS Lambda
- 🔄 Efficient data streaming with AWS S3
...
[![Email](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:vedantpawar18@gmail.com)
...
## 📈 Activity Graph
[![Vedant's github activity graph](https://github-readme-activity-graph.vercel.app/graph?username=vedantpawar18&theme=tokyo-night)](https://github.com/vedantpawar18)
